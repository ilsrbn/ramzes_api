...
export class CreateFeaturedPhotosColumn1678625058393 implements MigrationInterface {
    name = 'CreateFeaturedPhotosColumn1678625058393'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`post\` ADD \`featured_photos\` json NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`post\` DROP COLUMN \`featured_photos\``);
    }
