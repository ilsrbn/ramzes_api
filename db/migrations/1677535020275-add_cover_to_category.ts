...
export class addCoverToCategory1677535020275 implements MigrationInterface {
    name = 'addCoverToCategory1677535020275'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`category\` ADD \`coverId\` int NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`category\` DROP COLUMN \`coverId\``);
    }
